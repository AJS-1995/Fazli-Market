...
namespace ServiceHost.Areas.Administration.Pages.PeoplesAccounts.ShopkeeperAccounts.Rent
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IRentApplication rentApplication, IShop_For_RentApplication shop_For_RentApplication,
        ...
        public void OnGet(int id)
        {
            ...
            Rent = _rentApplication.GetViewModel().Where(x => x.Status == true && x.ForRent_Id == id).ToList();
        ...
        public IActionResult OnGetRemoved(int id)
        {
            ...
            {
                Rents = _rentApplication.GetViewModel().Where(x => x.Status == false && x.ForRent_Id == id).ToList(),
                Id = id,
            };
            Id = id;
